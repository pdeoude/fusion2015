...
%TODO why do we have a seperate section? This is also about planning, as is the previous section. right? The previous section defined the POMDP, this one describes methods to solve POMDPs
...
%TODO would be great if this example could be connected to the smuggler example. Too premature. We don't yet know the full details. This picture describes the technique, regardless of the application. 
\begin{figure}
\begin{center}
