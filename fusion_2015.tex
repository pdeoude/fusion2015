...
\title{Application of Dynamic Decision Networks for Scenario-based Reasoning} % choose your own 
%title 
%and we can discuss it before submitting
...
% For practical reasons the search area is discretized into cells. In each cell we want to reason about the presence of the aircraft
