...
\begin{itemize}
%\item Based on the sensor payload of an agent, an observation model describes its footprint, modeled as $(VO_t), (RO_t), (SO_t)$ in the BN
...
%TODO this section feels disconnected from the rest. I suggest to connect it to the example and scenario-based reasoning
...
%TODO would be great if this example could be connected to the smuggler example
\begin{figure}
\begin{center}
